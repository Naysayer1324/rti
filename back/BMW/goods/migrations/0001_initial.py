    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('acceleration', models.DecimalField(decimal_places=2, default=0.0, max_digits=3, verbose_name='Разгон')),
                ('consumption', models.DecimalField(decimal_places=2, default=0.0, max_digits=3, verbose_name='Расход')),
